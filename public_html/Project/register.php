...
<div class="container-fluid">
    ...
    <form onsubmit="return validate(this)" method="POST">
        ...
        <div>
            ...
            <input type="text" name="username" required maxlength="30" required value = "<?php se($username); ?>" />
        </div>
        <div>
            <label for="pw">Password</label>
            <input type="password" id="pw" name="password" require minlength = "8" />
        </div>
        <div>
            <label for="confirm">Confirm</label>
            <input type="password" name="confirm" require minlength = "8"/>
        </div>
